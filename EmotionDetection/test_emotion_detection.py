...
class TestEmotionDetection(unittest.TestCase):
    def test_emotion_detector(self):
        self.asserEqual(emotion_detector("I am glad this happened")["dominant_emotion"], "joy")
        ...
        self.asserEqual(emotion_detector("I am really afraid that this will happen")["dominant_emotion"], "fear")
